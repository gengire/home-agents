...
## How to Add Entries
Tell HomeChef what you made after a cook session:
> `@HomeChef Log what we cooked this week`

HomeChef will append rows in the format below.
...
| 2026-05-08 | Black Bean and Sweet Potato Enchilada Casserole | MEX |  | 4 | Yes | 90 | PREF: Used the full can (20 oz) of enchillada sauce; PREF: Added Greek yogurt topping; PREF: Added fresh mango; PREF: Added fresh avocado slices topping |
...
| Code | Category |
|------|----------|
| `IND-L` | Indian — Legume/Dal |
| `IND-P` | Indian — Protein |
| `IND-V` | Indian — Vegetable |
| `MED` | Mediterranean |
| `MEX` | Mexican/Latin |
| `ASIA` | Asian |
| `SOUP` | Soup/Stew |
